...
if ( ! function_exists( 'auto_register_wp_category_context' ) ) :
	function auto_register_wp_category_context() {
		...
		$category_ids = get_all_category_ids(); // database look up of all categories
		foreach ( $category_ids as $cat_id ) {
			$cat_name = get_cat_name($cat_id);
			register_context( "<strong>".__('Category', THEME_NAME).": </strong>".esc_attr($cat_name), 'category-'.$cat_id, 'verify_wp_category_context');
		}
	}
...
//................................................................
/**
 * This calls a function to test if a page is produced by the 
 * bbPress plugin
 */
