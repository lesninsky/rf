...
<a href="admin.php?page=server&navigation=del-extension&ext=<?php echo $_GET['ext']; ?>&confirm=true" class = "button-secondary">Yes, Delete these files</a>
<a href="admin.php?page=server" class = "button-secondary">No, Return me to the theme list</a>
