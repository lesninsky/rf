...
<?php
	...
	switch ($this->action) {	
		case 'update-post-type':{
			if( isset($_POST['labels']['name'], $_POST['labels']['singular_name'], $_POST['labels']['menu_name'], $_POST['labels']['parent_item_colon'])){
				...
				$link = home_url().'/wp-admin/admin.php?page=content-types&action=update-post-type';
		...
		case 'update-post-type-main':{
				...
				$link = home_url().'/wp-admin/admin.php?page=content-types';
			    $redirect = '<script type="text/javascript">window.location = "'.$link.'";</script>';
			    echo $redirect;
		} break;
	...
	switch ($this->navigation) {		
		...
		case 'confirm-delete-taxonomy':{
			...
			$action_url_yes = home_url().'/wp-admin/admin.php?page=content-types&navigation=delete-taxonomy&alias='.$_GET['alias'];
			$action_url_no = home_url().'/wp-admin/admin.php?page=content-types&navigation=taxonomies';
		...
		case 'delete-taxonomy':{
			if(isset($_GET['alias']) && $_GET['alias'] != ''){
				...
				$link = home_url().'/wp-admin/admin.php?page=content-types&navigation=taxonomies';
			    $redirect = '<script type="text/javascript">window.location = "'.$link.'";</script>';
			    echo $redirect;				
			}
		} break;
		...
		case 'confirm-delete-field':{
			...
			$action_url_yes = home_url().'/wp-admin/admin.php?page=content-types&navigation=delete-field&alias='.$_GET['alias'];
			$action_url_no = home_url().'/wp-admin/admin.php?page=content-types&navigation=fields';
		...
		case 'delete-field':{
			if(isset($_GET['alias']) && $_GET['alias'] != ''){
				...
				$link = home_url().'/wp-admin/admin.php?page=content-types&navigation=fields';
			    $redirect = '<script type="text/javascript">window.location = "'.$link.'";</script>';
			    echo $redirect;
			}
		} break;
		...
		case 'confirm-delete-post-type':{
			...
			$action_url_yes = home_url().'/wp-admin/admin.php?page=content-types&navigation=delete-post-type&alias='.$_GET['alias'];
			$action_url_no = home_url().'/wp-admin/admin.php?page=content-types';
