		...
		<dl class="menu-item-bar">
			<dt class="menu-item-handle">
				...
				<span class="item-controls">
					<span class="item-type">{{if item['source'] === undefined}}<?php echo __('Custom', 'framework'); ?>{{else}}${item['source']}{{/if}}</span>
					<a class="item-edit" id="" title="<?php echo __('Edit Menu Item', 'framework'); ?>" href="#" onclick="return false;"><?php echo __('Edit Menu Item', 'framework'); ?></a>
				</span>
			</dt>
		</dl>
		...
		<div class="menu-item-settings" id="menu-item-settings-21" style="display: none; ">
			...
			<p class="field-permissions permissions permissions-wide">
				<label for="edit-menu-item-permissions-21">
					<?php echo __('Permissions', 'framework'); ?><br>
...
foreach ( $wp_roles->roles[administrator][capabilities] as $cap => $name ):
					...
					<span class="description"><?php echo __('Capability to access this page.', 'framework'); ?></span>
				</label>
			</p>
			<p class="field-url description description-wide">
				<label for="edit-menu-item-url-21">
					<?php echo __('URL', 'framework'); ?><br>
			...
			<div class="menu-item-actions description-wide submitbox">
				<a class="item-delete submitdelete deletion" id="" href="#"><?php echo __('Remove', 'framework'); ?></a>
				<span class="meta-sep"> | </span>
				<a class="item-cancel submitcancel" id="cancel-21" href="#"><?php echo __('Cancel', 'framework'); ?></a>
				<span class="meta-sep"> | </span>
				<a class="default-settings submitcancel" id="cancel-21" href="#"><?php echo __('Get settings from...', 'framework'); ?></a>
			</div>
...
<script id="menu-spacer-tmpl" type="text/x-jquery-tmpl">
	<li id="" class="menu-item menu-item-custom pending"
		...
		<dl class="menu-item-bar">
			<dt class="menu-item-handle">
				<span class="item-title"><?php echo __('Spacer', 'framework'); ?></span>
				<span class="item-controls">
					<span class="item-type">{{if item['source'] === undefined}}<?php echo __('Custom', 'framework'); ?>{{else}}${item['source']}{{/if}}</span>
					<a class="item-edit" id="" title="<?php echo __('Edit Menu Item', 'framework'); ?>" href="#" onclick="return false;"><?php echo __('Edit Menu Item', 'framework'); ?></a>
				</span>
		...
		<div class="menu-item-settings" id="menu-item-settings-21" style="display: none; ">
			<div class="menu-item-actions description-wide submitbox">
				<a class="item-delete submitdelete deletion" id="" href="#"><?php echo __('Remove', 'framework'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-21" href="<?php home_url(); ?>/wp-admin/nav-menus.php?edit-menu-item=21&amp;cancel=1346668427#menu-item-settings-21"><?php echo __('Cancel', 'framework'); ?></a>
			</div>
	...
	<li class="menu-item menu-item-custom pending menu-item-depth-0" style="display: list-item; position: relative; "
		...
		<dl class="menu-item-bar">
			<dt class="menu-item-handle">
				<span class="item-title">${item[0]}</span>
				<span class="item-controls">
					<a class="item-restore" id="restore-delete-item" title="restore" href=""><?php echo __('Restore', 'framework'); ?></a>
					<a class="item-edit" id="" title="<?php echo __('Edit Menu Item', 'framework'); ?>" href="#" onclick="return false;"><?php echo __('Edit Menu Item', 'framework'); ?></a>
				</span>
			</dt>
		</dl>
	...
	<div id="menu-settings-column" class="metabox-holder">
		<div id="side-sortables" class="meta-box-sortables ui-sortable">
			...
			<div id="nav-menu-theme-locations" class="postbox ">
				<div class="handlediv" title="<?php echo __('Click to toggle', 'framework'); ?>">
					<br>
				</div>
				<h3 class="hndle"><span><?php echo __('New menu items', 'framework'); ?></span></h3>
				<div class="inside">
					<ul class="new-items">
						<li class="menu-item menu-item-custom pending menu-item-template-to-clone">
							<dl class="menu-item-bar">
								<dt class="menu-item-handle">
									<span class="item-title"><?php echo __('Menu item', 'framework'); ?></span>
								</dt>
							</dl>
						</li>
						<li class="menu-item menu-item-custom pending menu-spacer-template">
							<dl class="menu-item-bar">
								<dt class="menu-item-handle">
									<span class="item-title"><?php echo __('Spacer', 'framework'); ?></span>
									<span class="item-controls">
										<span class="item-type"><?php echo __('Custom', 'framework'); ?></span>
									</span>
								</dt>
							</dl>
						</li>
			...
			<div id="add-custom-links" class="postbox ">
				...
				<h3 class="hndle"><span><?php echo __('Deleted menu items', 'framework'); ?></span></h3>
				<div class="inside">
					...
					<div id="nav-menu-header">
						<div id="submitpost" class="submitbox">
							<div class="major-publishing-actions">
								...
								<button class="button-primary ajax-save"><?php echo __('Save menu', 'framework'); ?></button>
							</div>
						</div>
					</div>
