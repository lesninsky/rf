<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('import-categories'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&what=categories" class="nav-tab nav-tab-active">Import</a>
	<a href="<?php echo $this->self_url('export-categories'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&what=categories" class="nav-tab">Export</a>	
</div>
<?php 
...
<div class="postbox">
	...
	<h3 class="hndle"><span>Server Categories</span></h3>
	<div class="inside" >
		<a href="<?php echo $this->self_url('import-categories'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import-all&what=categories" id="import-all-categories" class="add-new-h2">Import All</a><br/><br/>		
						...
						foreach ($server_categories as $key => $value) {
							...
							?>
								<tr calss="active">
									...
									<td class="column-description desc">
										<a href="<?php echo $this->self_url('import-categories'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&item-id=<?php echo $key; ?>&what=categories" class="">Import</a>
									</td>	
								</tr>
							<?php
							}
