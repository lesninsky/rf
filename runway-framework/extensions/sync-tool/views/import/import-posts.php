<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('import-posts'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&what=posts" class="nav-tab nav-tab-active">Import</a>
	<a href="<?php echo $this->self_url('export-posts'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&what=posts" class="nav-tab">Export</a>	
</div>
<?php 
...
<div class="postbox">
	...
	<h3 class="hndle"><span>Server Posts</span></h3>
	<div class="inside" >
		<a href="<?php echo $this->self_url('import-posts'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import-all&what=posts" id="import-all-posts" class="add-new-h2">Import All</a><br/><br/>
						...
						foreach ($server_posts as $key => $value) {
							...
							?>
								<tr calss="active">
									...
									<td class="column-description desc">
										<a href="<?php echo $this->self_url('import-posts'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&item-id=<?php echo $i; ?>&what=posts" class="">Import</a>
									</td>	
								</tr>
							<?php
							}
