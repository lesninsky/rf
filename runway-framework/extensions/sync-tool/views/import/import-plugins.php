						...
						<td class="column-description desc">
							<?php
								if(isset($local_plugins[$key])){
									...
									?>
									<a href="http://runway.loc/wp-admin/plugin-install.php?tab=plugin-information&plugin=<?php echo $plugin; ?>&TB_iframe=true&width=640&height=359" class="thickbox" title="More information about Akismet 2.5.7"><?php echo __('Details', 'framework'); ?></a><br>
									<?php		
