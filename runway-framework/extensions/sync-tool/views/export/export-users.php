...
<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('import-users'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&what=users" class="nav-tab">Import</a>
	<a href="<?php echo $this->self_url('export-users'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&what=users" class="nav-tab nav-tab-active">Export</a>	
</div>
...
<div class="postbox">
	...
	<h3 class="hndle"><span>Local Users</span></h3>
	<div class="inside" >
		<a href="<?php echo $this->self_url('export-users'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export-all&what=users" id="export-all-users" class="add-new-h2">Export All</a><br/><br/>		
						...
						?>
							<tr calss="active">
								...
								<td class="column-description desc">
									...
									<a href="<?php echo $this->self_url('export-users'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&item-id=<?php echo $i; ?>&what=users" class="">Export</a>
									<?php else: ?>
