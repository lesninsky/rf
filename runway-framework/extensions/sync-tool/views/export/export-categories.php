...
<br><div class="nav-tabs nav-tabs-second">
	...
	<a href="<?php echo $this->self_url('import-categories'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=import&what=categories" class="nav-tab">Import</a>
	<a href="<?php echo $this->self_url('export-categories'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&what=categories" class="nav-tab nav-tab-active">Export</a>	
</div>
...
<div class="postbox">
	...
	<h3 class="hndle"><span>Local Categories</span></h3>
	<div class="inside" >
		<a href="<?php echo $this->self_url('export-categories'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export-all&what=categories" id="export-all-categories" class="add-new-h2">Export All</a><br/><br/>		
							...
							?>
								<tr calss="active">
									...
									<td class="column-description desc">
										...
										<a href="<?php echo $this->self_url('export-categories'); ?>&action=connection&connection_id=<?php echo $connection_id; ?>&operation=export&item-id=<?php echo $key; ?>&what=categories" class="">Export</a>
										<?php else: ?>
