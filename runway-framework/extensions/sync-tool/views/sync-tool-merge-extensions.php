		...
		<tbody id="the-list">
			<?php foreach ((array)$diff_extensions['must_be_active'] as $extension => $extension_info) : ?>
				<tr class="active">
					...
					<td class="plugin-title" style="text-align:left;">
						<a href="<?php echo home_url().'/wp-admin/themes.php?page=extensions&navigation=extension-activate&ext='.$extension; ?>" title="<?php echo __('Connect', 'framework'); ?>" class="connect"><?php echo __('Activate', 'framework'); ?></a>
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
